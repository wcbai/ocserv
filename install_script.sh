...
cd /etc/ocserv/
rm -rf ocserv.conf
wget https://raw.githubusercontent.com/wuchangbai888/ocserv/master/ocserv.conf
#
cd /root/anyconnect
wget https://raw.githubusercontent.com/wuchangbai888/ocserv/master/gen-client-cert.sh
wget https://raw.githubusercontent.com/wuchangbai888/ocserv/master/user_add.sh
wget https://raw.githubusercontent.com/wuchangbai888/ocserv/master/user_del.sh
